...
def onPluginStart():
    DoActions([  # Basic DatFile Actions
        ...
        SetMemory(0x66209C, Add, -50331648),# units:Right-click Action  index:7    from 5 To 2
        SetMemory(0x6620A0, Add, 65536),# units:Right-click Action  index:10    from 1 To 2
