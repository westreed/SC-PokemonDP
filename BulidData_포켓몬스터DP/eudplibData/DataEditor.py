...
def onPluginStart():
    DoActions([  # Basic DatFile Actions
        ...
        SetMemory(0x6623A8, Add, -153600),# units:Hit Points  index:22    from 204800 To 51200
        ...
        SetMemory(0x663DE4, Add, -655360),# units:Rank/Sublabel  index:22    from 15 To 5
        ...
        SetMemory(0x6636CC, Add, -8257536),# units:Ground Weapon  index:22    from 130 To 4
        ...
        SetMemory(0x6640D8, Add, -1109426500),# units:Special Ability Flags  index:22    from 1512079684 To 402653184
        ...
        SetMemory(0x662DCC, Add, 327680),# units:Target Acquisition Range  index:22    from 0 To 5
        ...
        SetMemory(0x6635E4, Add, 60),# units:Armor Upgrade  index:20    from 0 To 60
        SetMemory(0x6635E4, Add, 256),# units:Armor Upgrade  index:21    from 2 To 3
        SetMemory(0x6635E4, Add, 65536),# units:Armor Upgrade  index:22    from 2 To 3
        ...
        SetMemory(0x65FEDC, Add, -65536),# units:Armor  index:22    from 4 To 3
        ...
        SetMemory(0x6628B8, Add, -53),# units:StarEdit Placement Box Width  index:22    from 65 To 12
        ...
        SetMemory(0x6628B8, Add, -2490368),# units:StarEdit Placement Box Height  index:22    from 50 To 12
        ...
        SetMemory(0x661878, Add, -26),# units:Unit Size Left  index:22    from 32 To 6
        ...
        SetMemory(0x661878, Add, -1769472),# units:Unit Size Up  index:22    from 33 To 6
        ...
        SetMemory(0x66187C, Add, -26),# units:Unit Size Right  index:22    from 32 To 6
        ...
        SetMemory(0x66187C, Add, -655360),# units:Unit Size Down  index:22    from 16 To 6
        ...
        SetMemory(0x662FB4, Add, 4),# units:Portrait  index:22    from 9 To 13
        ...
        SetMemory(0x660454, Add, -2399),# units:Build Time  index:22    from 2400 To 1
        ...
        SetMemory(0x663EE4, Add, -2499),# units:Destroy Score  index:22    from 2500 To 1
